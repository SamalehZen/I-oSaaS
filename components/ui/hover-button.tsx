...
const HoverButton = React.forwardRef<HTMLButtonElement, HoverButtonProps>(
  (
    { className, children, startColor = "#93c5fd", endColor = "#3b82f6", animationIntensity = "medium", ...props },
    ref,
  ) => {
    ...
    return (
      ...
      >
        ...
        {typeof children === "string" ? <span className="relative z-10 drop-shadow-md">{children}</span> : children}
      </button>
    )
  },
)
